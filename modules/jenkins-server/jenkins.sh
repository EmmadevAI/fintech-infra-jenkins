...
server {
    listen 80;
    server_name jenkins.cloudsroot.com;
...
sudo certbot --nginx \
  --non-interactive \
  --agree-tos \
  --email emmanueltetteh.dev@gmail.com \
  -d jenkins.cloudsroot.com
...
echo "✅ Jenkins is now available at: https://jenkins.cloudsroot.com"
